...
async function seed() {
  ...
  try {
    ...
    // Create historical energy generation records from Aug 1, 2025 8pm to now every 2 hours
    const records = [];
    const startDate = new Date("2025-08-01T08:00:00Z"); // August 1, 2025 8am UTC
